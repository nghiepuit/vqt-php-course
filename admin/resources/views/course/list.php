		...
		<table class="table table-bordered table-hover datatable-highlight">
			...
			<tbody>
				<tr>
					...
					<td><a href="index.php?con=category&act=edit&cid=1">PHP</a></td>
					...
					<td class="text-center">
						<ul class="icons-list">
							<li class="text-primary-600"><a href="index.php?con=course&act=edit&cid=1" data-popup="tooltip" title="Edit"><i class="icon-pencil7"></i></a></li>
							<li class="text-danger-600"><a href="index.php?con=course&act=delete&cid=1" data-popup="tooltip" title="Remove" class="sweet_warning"><i class="icon-trash"></i></a></li>
						</ul>
					</td>
				</tr>
				<tr>
					<td>2</td>
					<td><a href="index.php?con=course&act=edit&cid=1">Lập Trình PHP Nâng Cao </a></td>
					<td><a href="index.php?con=category&act=edit&cid=1">PHP</a></td>
					<td><input type="checkbox" name="chkStatus" data-on-color="success" data-off-color="danger" data-on-text="On" data-off-text="Off" class="switch" data-id="1" /></td>
					<td><input type="checkbox" name="chkStatus" data-on-color="success" data-off-color="danger" data-on-text="On" data-off-text="Off" class="switch" data-id="1" /></td>
					<td class="text-center">
