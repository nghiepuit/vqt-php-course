	...
	<div class="col-md-8">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h6 class="panel-title">Category Edit</h6>
					...
					<div class="tab-content">
						<div class="tab-pane has-padding active" id="vietnamese">
							<div class="form-group">
								...
								<input type="text" id="name-slug-vi" name="txtNameVi" class="form-control" placeholder="Please Enter Category Name" />
							</div>
							<div class="form-group">
						...
						<div class="tab-pane has-padding" id="english">
							<div class="form-group">
								...
								<input type="text" id="name-slug-en" name="txtNameEn" class="form-control" placeholder="Please Enter Category Name" />
							</div>
							<div class="form-group">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body" style="display: block;">
				...
				<div class="form-group">
					...
					<input type="text" name="txtPosition" class="touchspin-basic" value="1" />
				</div>
				<div class="form-group">
